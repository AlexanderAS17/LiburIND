...
public class Destination {
	...
	public Destination(String destinationId, String destinationName, BigDecimal destinationRating,
	...
	public static Destination mapJson(JsonNode jsonNode) {
		...
		return new Destination(destinationId, destinationName, destinationRating, destinationDetail,
